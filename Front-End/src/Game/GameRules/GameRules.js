    ...
    render() {
        ...
        return(
            ...
            <div className="card rules center p-2" hidden={this.props.hide}>
                ...
                <p>
                    You may click <button className="btn-primary btn-sm">HIT</button> until you have a desired amount of cards, or until
                    you reach a sum greater than 21. If this occurs, your hand of cards is 
                    bust and the dealer automatically wins the round.
                </p>

                <p>
                    If you do not wish to draw more cards you may <button className="btn-primary btn-sm">STAND</button> your hand which will 
                    determine a winner for the round.
                </p>

                <p>
                    Once a winner is determined, you may click <button className="btn-primary btn-sm">Next Game</button> which will begin 
